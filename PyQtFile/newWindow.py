...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        # 设置背景图片
        background_image = QPixmap("scripts/bg12.jpg")
        background_palette = self.palette()
        background_palette.setBrush(QPalette.Window, QBrush(background_image))
    ...
    def initUI(self):
        ...
        # 添加菜单
        self.menu = QtWidgets.QMenu("菜单", self.menubar)
        self.menu.setObjectName("menu")
        self.menu_2 = QtWidgets.QMenu("关于", self.menubar)
        self.menu_2.setObjectName("menu_2")
        self.menu_3 = QtWidgets.QMenu("设备选择", self.menubar)
        self.menu_3.setObjectName("menu_3")

        # 添加子选项到菜单中
        self.action = QtWidgets.QAction("选择模型路径", self)
        self.action.setObjectName("action")
        self.action.triggered.connect(self.select_model_path)  # 连接信号和槽函数

        self.action_2 = QtWidgets.QAction("选择图片路径", self)
        self.action_2.setObjectName("action_2")
        self.action_2.triggered.connect(self.select_model_path)  # 连接信号和槽函数
        ...
        # 添加子选项到设备选择菜单
        self.actionCPU = QtWidgets.QAction("CPU", self)
        self.actionCPU.setObjectName("actionCPU")
        self.actionCUDA = QtWidgets.QAction("CUDA", self)
        self.actionCUDA.setObjectName("actionCUDA")
        self.actionCUDA.setCheckable(True)
        self.actionCUDA.setChecked(True)
        self.menu_3.addAction(self.actionCPU)
        self.menu_3.addAction(self.actionCUDA)

        # self.action_4 = QtWidgets.QAction("查看历史记录", self)
        # self.action_4.setObjectName("action_4")
        # self.menu.addAction(self.action_4)

        self.actionmayday = QtWidgets.QAction("刘浩宇", self)
        ...
        self.setWindowTitle('农作物病害区域分割与面积估算')
        ...
        self.title_label.setPixmap(QPixmap('scripts/title-2.png'))
        ...
        #创建计算按钮
        self.general_button = QPushButton('混合并计算', self)
        ...
        # 设置透明度
        self.table.setStyleSheet("background-color: rgba(255, 255, 255, 150);")
    ...
    def select_model_path(self):
            ...
            directory = QFileDialog.getExistingDirectory(self, "选择模型路径", ".", options=options)
            if directory:
                print(directory)
